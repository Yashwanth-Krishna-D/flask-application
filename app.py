...
footer_content = "//This is a footer text.. modify them later"

@app.route('/')
def homePage():
  return render_template("home.html", about = about_content, education = education_content , footer = footer_content)
